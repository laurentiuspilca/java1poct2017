...
public class AngajatiFrame extends javax.swing.JFrame {
    ...
    private void afisareAngajati() {
        model.clear();
        List<Angajat> angajati = DatabaseController.getInstance().getAngajati();
    ...
    private void initComponents() {
        ...
        jList1 = new javax.swing.JList<Angajat>();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        double salariu = Double.parseDouble(jTextField2.getText());
        
        Angajat a = new Angajat();
        a.setNume(nume);
        a.setSalariu(salariu);
        DatabaseController.getInstance().adaugaAngajat(a);
        afisareAngajati();
